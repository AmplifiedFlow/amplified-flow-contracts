...
contract AmplifiedFlowCompoundStaking is Ownable, ReentrancyGuard {
    ...
    *************************/
    ...
    function setServiceInfo(address _treasuryWallet, uint256 _fee) external {
        require(msg.sender == treasuryWallet, "setServiceInfo: FORBIDDEN");
        ...
        emit ServiceInfoUpadted(_treasuryWallet, _fee);
    }
